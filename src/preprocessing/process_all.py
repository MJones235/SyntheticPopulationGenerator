...
from loaders.uk_census_loader import UKCensusLoader
from transformers.uk_census_transformer import UKCensusTransformer
...
def main():
    for location_dir in RAW_DATA_DIR.iterdir():
        ...
        if location_dir == "global": continue
        print(f"\n📍 Processing location: {location_dir.name}")
